                ...
                <div class="card mb-3">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="${
                              character.image
                            }" class="card-img-top" alt="${character.fullName}">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title">${
                                ...
                                ${
                                  character.nicknames.length > 0
                                    ? `<p class="card-text">Surnoms: ${character.nicknamesList}</p>`
                                    : ""
                                }
                                    ...
                                    <div class="btn-group">
                                        ...
                                        ${
                                          isFavorite
                                            ...
                                            : "<button class='btn btn-sm btn-outline-secondary add-favorite-btn' data-id='" +
                                              character.id +
